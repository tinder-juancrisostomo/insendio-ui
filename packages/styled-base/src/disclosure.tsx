...
export function DisclosureTrigger({ className, ...props }: BaseDisclosureTriggerProps) {
  return (
    <BaseDisclosureTrigger
      className={cn(
        'flex w-full items-center justify-between rounded-md border border-gray-200 bg-gray-50 px-4 py-2 text-left font-medium hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500',
        className
      )}
      {...props}
    />
