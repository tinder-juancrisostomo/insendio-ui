/**
 * @design-system/shadcn-radix
 * Shadcn's model: Radix UI primitives + Tailwind + design tokens
 */
...
// Layout primitives
export { Box, Container, Stack, Inline, Grid, Spacer, Divider, Center } from '@design-system/base';

// Additional APG patterns (headless, from base)
export { RangeSlider, TreeView, TreeGrid, WindowSplitter } from '@design-system/base';

// Landmarks (headless, from base)
