...
Components copied from shadcn/ui via CLI. Radix + Tailwind + CVA—the copy-paste model.
...
**Description:** Components copied from shadcn/ui via CLI (Radix + Tailwind + CVA)  
...
| Source | Components |
|--------|------------|
| **shadcn/ui (copied)** | Button, Input, Badge, Dialog, AlertDialog, Tabs, DropdownMenu, Switch, Accordion (from Radix) |
| **base** | Carousel, Breadcrumb, Combobox, Disclosure, Link, Listbox, Slider, Toolbar, Tooltip, Layout, etc. |
